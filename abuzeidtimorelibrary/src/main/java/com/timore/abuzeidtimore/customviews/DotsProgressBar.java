package com.timore.abuzeidtimore.customviews;
...
public class DotsProgressBar extends View {
	...
	private void init(Context context) {
		...
		mPaintFill.setColor(getResources().getColor(R.color.img_pbar_startColor));
		// dot background color
		mPaint.setStyle(Style.FILL);
		mPaint.setColor(getResources().getColor(R.color.img_pbar_endColor));
		start();
	}
